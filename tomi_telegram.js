...
Если продавец спрашивает "покажи предоплаты", "открытые предоплаты", "есть ли предоплата у [имя]" — выведи:
PREPAY_LIST:открытые
Если спрашивает ИМЕННО "закрытые предоплаты", "история", "все предоплаты" — выведи:
PREPAY_LIST:все
...
Если Ермек просит показать предоплаты:
- "открытые", "список", "предоплаты" — выведи PREPAY_LIST:открытые
- "закрытые", "история", "все" — выведи PREPAY_LIST:все
